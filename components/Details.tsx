    ...
    <section className="w-full max-w-3xl space-y-8" id="requirements">
        ...
        <div className="bg-[#112240] border border-[#61DBFB] rounded-lg shadow-lg p-8 space-y-6">
          ...
          <ul className="space-y-3 list-inside list-disc text-gray-200">
            ...
            <li>Note: Your submission needs to be meaningful (eg. a portfolio, or a website showcasing your favourite artists) and also use relevant APIs (eg. using a <a className="text-[#61DBFB] hover:text-[#7FDBFF] hover:underline" href="https://dummyjson.com/docs/posts">Dummy posts API</a> for a blog page instead of using a lorem ipsum API).</li>
          </ul>
          <div className="flex justify-end gap-3">
            ...
            <Button href="https://forms.hackclub.com/reactive-submissions">Submit</Button>
          </div>
        </div>
      </section>
  )
